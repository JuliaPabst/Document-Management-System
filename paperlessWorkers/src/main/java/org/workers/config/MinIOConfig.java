...
/**
 * Configures MinIO client for object storage operations in worker services
 */
@Configuration
@Slf4j
@Getter
public class MinIOConfig {
	...
	public MinioClient minioClient() {
		try {
			log.info("Initializing MinIO client for Workers - endpoint: {}:{}, bucket: {}, ssl: {}",
