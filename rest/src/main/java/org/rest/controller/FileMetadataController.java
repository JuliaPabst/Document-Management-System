...
public class FileMetadataController {
    ...
    public ResponseEntity<FileMetadataResponseDto> uploadFileMetadata(
        ...
        FileMetadataResponseDto response = fileMetadataService.createFileMetadata(createDto);
    ...
    public ResponseEntity<FileMetadataResponseDto> getFileMetadata(
        ...
        FileMetadataResponseDto response = fileMetadataService.getFileMetadataById(id);
    ...
    public ResponseEntity<List<FileMetadataResponseDto>> getAllFileMetadata(
        ...
        if (search != null && !search.trim().isEmpty()) {
            response = fileMetadataService.searchFileMetadata(search.trim());
        } else if (author != null && !author.trim().isEmpty()) {
            response = fileMetadataService.getFileMetadataByAuthor(author.trim());
        } else if (fileType != null && !fileType.trim().isEmpty()) {
            response = fileMetadataService.getFileMetadataByFileType(fileType.trim());
        } else {
            response = fileMetadataService.getAllFileMetadata();
        }
    ...
    public ResponseEntity<FileMetadataResponseDto> updateFileMetadata(
        ...
        FileMetadataResponseDto response = fileMetadataService.updateFileMetadata(id, updateDto);
        return ResponseEntity.ok(response);
    }
